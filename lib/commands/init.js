...
cli
    ...
    .action(function(config) {
        ...
        var platformEndpoint = projectConfig['28'].platformEndpoint.replace(/dockerhost/, 'localhost');
        Config.config.endpoint = platformEndpoint;
        Config.config.projectEndpoint = platformEndpoint.replace(/portal/, '<%= projectName %>');
        Config.save();
