...
var $28 = (function() {
    ...
    $28.prototype.getCustomRewriteRules = function(projectName, token){
        return this.api.Project.getCustomRewriteRules({ name: projectName, token: token });
    };

    $28.prototype.setCustomRewriteRules = function(projectName, token, customRewrites) {
        return this.api.Project.setCustomRewriteRules({ name: projectName, token: token, customRewrites: customRewrites })
    };
