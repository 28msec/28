...
.option('-d, --delete-orphanated', 'Delete orphanated files.')
...
.action(function(projectName){
    ...
    .then(function(){
        ...
        if(projectToken) {
            ffs.mkdirRecursiveSync('lib', 0777);
            ffs.mkdirRecursiveSync('public', 0777);
            ffs.mkdirRecursiveSync('private', 0777);
            ...
            .then(function(lists){
                ...
                Client.download(
                    ...
                    dlCmd.deleteOrphanated ? true : false, 
                    dlCmd.overwrite ? dlCmd.overwrite : Client.OVERWRITE_ASK, 
